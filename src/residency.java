...
public class residency extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CERTIFICATE OF RESIDENCY ");
        ...
        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 29)); // NOI18N
        jLabel4.setText("Starting year:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 180, -1));
        ...
        jPanel1.add(year, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 340, 210, 40));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        area.setText(area.getText()+"This is to certify that   "+name.getText()+",  "+age.getText()+" years of age, a resident of Sitio "+sitio.getText()+", of Lapasan Cagayan De Oro City, since  "+year.getText()
            + "  up to the present as stated on his/her Sitio clearance submitted to this office. ");
        area.setText(area.getText()+"\n");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ...
            try {
                PdfWriter.getInstance(doc , new FileOutputStream("RESIDENCY.pdf"));
            } catch (FileNotFoundException ex) {
                Logger.getLogger(residency.class.getName()).log(Level.SEVERE, null, ex);
            }
            doc.open();
