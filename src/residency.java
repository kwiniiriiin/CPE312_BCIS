...
public class residency extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        ...
        area.setText(area.getText() + "This is to certify that   " + name.getText() + ",  " + age.getText()
                + " years of age, a resident of Sitio " + sitio.getText() + ", of Lapasan\nCagayan De Oro City, since  "
                + year.getText()
                + "  up to the present as stated on his/her Sitio clearance submitted to this office. ");
        area.setText(area.getText() + "\n");
        area.setText(area.getText()
                + "\nThis certification is issued upon the request of the above name mentioned as a\nrequirement for "
                + purpose.getText() + " ");
