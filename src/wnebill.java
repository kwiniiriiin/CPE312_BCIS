...
public class wnebill extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        area.setText(area.getText()+"This is to certify that    "+name.getText()+", "+age.getText()+" years of age, a resident of Sitio "+sitio.getText()+", of Lapasan Cagayan De Oro City, is requesting for  "+con.getText()
        +" Connection.\n\n\nFurther, certify that the above named person is erecting his/her dwelling in Private land.\n\n");
        area.setText(area.getText()+"\n");
        area.setText(area.getText()+"This certification is Issued upon the request of the above name mentioned as a requirement for "+purpose.getText()+" ");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ...
            try {
                PdfWriter.getInstance(doc , new FileOutputStream("WNEBILL.pdf"));
