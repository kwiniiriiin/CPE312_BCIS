...
public class ftjs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FIRST TIME JOB SEEKER ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        area.setText(area.getText()+"This is to certify that   "+name.getText()+",  "+age.getText()+" years of age, a resident of Sitio "+sitio.getText()+", of Lapasan Cagayan De Oro City , "
        ...
        area.setText(area.getText()+"\n\nFurther , certify that the said person is a FIRST TIME JOB SEEKER.\n");
        
        area.setText(area.getText()+"\n\nThis certification is issued upon the request of the above named person as mentioned as a requirement for "+purpose.getText()+" ");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ...
            try {
                PdfWriter.getInstance(doc , new FileOutputStream("FTJS.pdf"));
